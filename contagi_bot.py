...
def info(update, context):
    update.message.reply_text("Questo bot è stato realizzato da due ragazzi che frequentano la quinta superiore in un istituto tecnico in Valle d'Aosta. "
                              "Il bot scarica ogni 10 minuti le informazioni dal sito del Ministero della Salute "
                              ...
                              "ne estrae i dati e risponde ai comandi dell'utente.")
